...
# Vector benchmark
g++ $COMPILATION_FLAGS $INCLUDE_FLAGS -DLIBLINALG_BACKEND_SIMD_SSE bench/src/vector_bench.cc -o bin/vector_bench 2> /dev/null
./bin/vector_bench

# Matrix benchmark
g++ $COMPILATION_FLAGS $INCLUDE_FLAGS -DLIBLINALG_BACKEND_SIMD_SSE bench/src/matrix_bench.cc -o bin/matrix_bench 2> /dev/null
./bin/matrix_bench

# Vector matrix benchmark
g++ $COMPILATION_FLAGS $INCLUDE_FLAGS -DLIBLINALG_BACKEND_SIMD_SSE bench/src/matrix_vector_bench.cc -o bin/matrix_vector_bench 2> /dev/null
./bin/matrix_vector_bench
